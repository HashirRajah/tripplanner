...
class RecommendedPOISectionDestination extends StatefulWidget {
  final String destination;
  final String uid;
  final List<int> likes;
  final Function updateLikes;
  //
  const RecommendedPOISectionDestination({
    super.key,
  ...
  @override
  State<RecommendedPOISectionDestination> createState() =>
      _RecommendedPOISectionDestinationState();
}

class _RecommendedPOISectionDestinationState
    extends State<RecommendedPOISectionDestination> {
