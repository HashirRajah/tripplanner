...
class POIDestinationCard extends StatefulWidget {
  final POIModel poi;
  final type;
  final String userId;
  final bool liked;
  ...
  @override
  State<POIDestinationCard> createState() => _POIDestinationCardState();
}

class _POIDestinationCardState extends State<POIDestinationCard> {
                ...
                onPressed: () async {
                  ...
                  if (context.mounted) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (newContext) => SimplePOIDetailsScreen(
                          poi: widget.poi,
                          liked: like,
