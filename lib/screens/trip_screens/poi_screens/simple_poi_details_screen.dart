...
class SimplePOIDetailsScreen extends StatefulWidget {
  final POIModel poi;
  final bool liked;
  final Function updateLikes;
  //
  const SimplePOIDetailsScreen({
    super.key,
    required this.poi,
    required this.liked,
  ...
  @override
  State<SimplePOIDetailsScreen> createState() => _SimplePOIDetailsScreenState();
}

class _SimplePOIDetailsScreenState extends State<SimplePOIDetailsScreen> {
  String imageLink =
