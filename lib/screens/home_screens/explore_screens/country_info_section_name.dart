...
class CountryInfoSectionWithName extends StatefulWidget {
  final String name;
  //
  const CountryInfoSectionWithName({
    super.key,
    required this.name,
  });

  @override
  State<CountryInfoSectionWithName> createState() =>
      _CountryInfoSectionWithNameState();
}

class _CountryInfoSectionWithNameState
    extends State<CountryInfoSectionWithName> {
  ...
  Future<void> fetchCountryInfo() async {
    ...
    //
    dynamic result = await rcService.getCountryInfoWithName(widget.name);
    //
    if (result == null) {
